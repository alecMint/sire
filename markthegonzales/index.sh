...
npmi
forever_run "$sireDir/_common/s3dl/index.js -d $installDir/web/wp-content/uploads -w /wp-content/uploads -b $s3Bucket/wp-content/uploads -p 9992,9000-9100,/etc/nginx/sites-available/markthegonzales"
cd $startpwd
